...
We need to do a `-replace` because of https://github.com/golang/go/issues/30354#issuecomment-466557015.
We have custom forks of Terraform and Terragrunt and in order to use TerraCost they need to be replaced when importing also.
