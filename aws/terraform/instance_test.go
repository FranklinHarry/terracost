		...
		expected := []query.Component{
			{
				...
				ProductFilter: &product.Filter{
					...
					AttributeFilters: []*product.AttributeFilter{
						...
						{Key: "Instance Type", Value: util.StringPtr("m5.xlarge")},
						{Key: "Tenancy", Value: util.StringPtr("Shared")},
						{Key: "Operating System", Value: util.StringPtr("Linux")},
						{Key: "Pre Installed S/W", Value: util.StringPtr("NA")},
					},
				},
		...
		expected := []query.Component{
			...
			},
			{
				...
				ProductFilter: &product.Filter{
					...
					Location: util.StringPtr("us-east-1"),
					AttributeFilters: []*product.AttributeFilter{
						{Key: "Volume API Name", Value: util.StringPtr("st1")},
					},
				},
			},
		}
